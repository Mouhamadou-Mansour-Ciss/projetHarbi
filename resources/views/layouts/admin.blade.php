        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="navbar-nav w-100">
                    ...
                    @if($userRole === 'admin')
                        <a href="{{ route('admin.listuser') }}" class="nav-item nav-link"><i class="fa fa-th me-2"></i>Liste des Utilisateurs</a>
                        @endif
                    @if($userRole === 'eleveur')
                        <a href="{{ route('moutons.index') }}" class="nav-item nav-link"><i class="fa fa-th me-2"></i>Liste des Moutons</a>
                        <a href="{{ route('moutons.create') }}" class="btn btn-primary">Ajouter un Mouton</a>
                    @endif
                </div>
            </nav>
        </div>
            ...
            <nav class="navbar navbar-expand bg-secondary navbar-dark sticky-top px-4 py-0">
                ...
                <div class="navbar-nav align-items-center ms-auto">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-end bg-secondary border-0 rounded-0 rounded-bottom m-0">
                            <a href="{{ route('users.modifier') }}" class="dropdown-item">Modifier My Profile</a>
                            <a href="{{ route('users.modifierPassword') }}" class="dropdown-item">Modifier Password</a>
                ...
                <div class="bg-secondary rounded-top p-4">
                    <div class="row">
                        <div class="col-12 col-sm-6 text-center text-sm-start">
                            &copy; <a href="#">Khar-bi</a>, All Right Reserved. 
                        </div>
                        <div class="col-12 col-sm-6 text-center text-sm-end">
                            <!--/*** This template is free as long as you keep the footer author’s credit link/attribution link/backlink. If you'd like to use the template without the footer author’s credit link/attribution link/backlink, you can purchase the Credit Removal License from "https://htmlcodex.com/credit-removal". Thank you for your support. ***/ https://htmlcodex.com-->
                             Conçu par<a href="#">Ciss98</a>
                            <br>Distributed By: <a href="#" target="_blank">contact@kharbi.com</a>
                        </div>
                    </div>
                </div>
            </div>
            <!-- Footer End  https://themewagon.com-->
        </div>
        <!-- Content End -->
